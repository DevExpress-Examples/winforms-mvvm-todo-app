...
Namespace TodoApp.ViewModels
    ...
    Public Class ItemsViewModel
        ...
        Public Sub New()
            ...
            Call Messenger.Default.Register(Me, New System.Action(Of ReloadRequired)(AddressOf OnReloadRequired))
        End Sub
        ...
        Private Sub OnReloadRequired(ByVal message As ReloadRequired)
        ...
        Private Sub ReloadItems(ByVal showAll As Boolean)
